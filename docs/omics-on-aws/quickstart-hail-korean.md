...
\![이미지](/img/omics-on-aws/Kr02024-07-08-00-47-27-1.png)
...
\![이미지](/img/omics-on-aws/VsQ2024-07-08-00-53-25.png)
...
\![이미지](/img/omics-on-aws/Nx42024-07-08-00-55-27.png)

이 주소를 CloudFormation 스택 생성시 템플릿 주소로 입력하고 스택을 만듭니다.

\![이미지](/img/omics-on-aws/k6tuntitled.png)

4.  Hail 스택을 만들기 위한 정보 입력을 진행합니다.

Stack 이름을 임의로 입력합니다.

\![이미지](/img/omics-on-aws/zTtuntitled-1.png)
...
\![이미지](/img/omics-on-aws/Xgnuntitled-9.png)
...
\![이미지](/img/omics-on-aws/38Runknown.png)
...
\![이미지](/img/omics-on-aws/Bp0untitled-11.png)

2.  Environment 섹션의 Additional configuration 을 확장해서 필요한 값을 입력합니다.

\![이미지](/img/omics-on-aws/jmvuntitled-12.png)

\![이미지](/img/omics-on-aws/aqWuntitled-13.png)
...
- 만일 hail-vep (VEP와 함께 설치) 옵션으로 빌드할 경우라면..
  ...
  \![이미지](/img/omics-on-aws/tIXunknown-1.png)
...
\![이미지](/img/omics-on-aws/AhQscreenshot-2024-06-22-at-8-52-43-pm.png)

또는

\![이미지](/img/omics-on-aws/QWyscreenshot-2024-06-18-at-5-35-01-pm.png)

\![이미지](/img/omics-on-aws/3K7screenshot-2024-06-18-at-5-35-18-pm.png)

\![이미지](/img/omics-on-aws/19Yscreenshot-2024-06-18-at-1-47-18-pm.png)

\![이미지](/img/omics-on-aws/zBJscreenshot-2024-06-18-at-1-50-45-pm.png)
...
\![이미지](/img/omics-on-aws/frPuntitled-23.png)
...
\![이미지](/img/omics-on-aws/ny2untitled-25.png)

\![이미지](/img/omics-on-aws/pw3screenshot-2024-07-08-at-12-08-40-pm.png)
