...
## **AWS HealthOmics는 무엇입니까?** {#bkmrk-%C2%A0-2}

### 중요 공지 {#bkmrk-%EC%A4%91%EC%9A%94-%EA%B3%B5%EC%A7%80}

[HealthOmics는 전문적인 의학적 조언, 진단 또는 치료를 대체하지 않으며 질병이나 건강 상태를 치료, 치료, 완화, 예방 또는 진단하기 위한 것이 아닙니다.임상 의사 결정에 정보를 제공하기 위한 타사 제품과 연계하는 것을 포함하여 AWS Healthomics를 사용할 때 인적 검토를 실시할 책임은 귀하에게 있습니다.]{style="color: rgb(224, 62, 45);"}\
...
- [Storage - 저장 (FASTQ, BAM, CRAM과 같은 유전체학 포멧을 저장하기 위한 서비스)](https://docs.aws.amazon.com/omics/latest/dev/what-is-healthomics.html#sequence-store-concepts){style="background-color: transparent; color: var(--color-text-link-default-yuoe9q,#0073bb); text-decoration: none;"}
- [Analytics](https://docs.aws.amazon.com/omics/latest/dev/what-is-healthomics.html#variant-store-concepts){style="background-color: transparent; color: var(--color-text-link-default-yuoe9q,#0073bb); text-decoration: none;"} - 데이터레이크 전처리 (즉, VCF를 다루기 위한 서비스)
- [Workflows](https://docs.aws.amazon.com/omics/latest/dev/what-is-healthomics.html#workflows-concepts){style="background-color: transparent; color: var(--color-text-link-default-yuoe9q,#0073bb); text-decoration: none;"} - 워크플로우 (Nextflow, WDL, CWL 등 유전체학 워크플로우를 간단하게 실행할 수 있도록 하는 인프라에 대한 관리형 서비스)

### 이점  {#bkmrk-%EC%9D%B4%EC%A0%90%C2%A0}
...
### Workflows {#bkmrk-workflows}

##### Ready2Run {#bkmrk-ready2run}

** **Ready2Run (R2R) 워크플로우를 제공합니다. GATK, Singlecell, AlphaFold 등 이미 최적화된 파이프라인을 사용해보세요.\

[\![\](/img/omics-on-aws/screenshot-2024-04-11-at-11-00-43-am.png)](/img/omics-on-aws/screenshot-2024-04-11-at-11-00-43-am.png){target="_blank" rel="noopener"}

[\![\](/img/omics-on-aws/screenshot-2024-04-11-at-11-01-05-am.png)](/img/omics-on-aws/screenshot-2024-04-11-at-11-01-05-am.png){target="_blank" rel="noopener"}

###  {#bkmrk--1}

##### Private workflow {#bkmrk-private-%EC%9B%8C%ED%81%AC%ED%94%8C%EB%A1%9C%EC%9A%B0-%EB%98%90%EB%8A%94-r2r}

Private 워크플로우 또는 R2R 워크플로우를 사용해 분석을 수행하면 아래와 같이 하나의 Run 에 수많은 Task단위의 로그 및 컴퓨팅 사용량을 확인할 수도 있습니다.

### [\![\](/img/omics-on-aws/screenshot-2024-04-11-at-11-01-56-am.png)](/img/omics-on-aws/screenshot-2024-04-11-at-11-01-56-am.png){target="_blank" rel="noopener"} {#bkmrk--3}

###  {#bkmrk-%C2%A0-3}

### Analytics {#bkmrk-analytics}
...
변이 데이터에 대한 지원 포멧: VCF  ( [Variant Effect Predictor (VEP) annotations 호환 가능.)]{style="color: rgb(15, 20, 26); font-family: 'Amazon Ember', Helvetica, Arial, sans-serif; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;"}

Annotation 데이터에 대한 지원 포멧: [TSV, VCF, or GFF ]{style="color: rgb(15, 20, 26); font-family: 'Amazon Ember', Helvetica, Arial, sans-serif; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;"}

###  {#bkmrk--4}

### 사용 방법 {#bkmrk-%EC%82%AC%EC%9A%A9-%EB%B0%A9%EB%B2%95}
...
### 사용 가능한 리전 및 Quota  {#bkmrk-%EC%82%AC%EC%9A%A9-%EA%B0%80%EB%8A%A5%ED%95%9C-%EB%A6%AC%EC%A0%84-%EB%B0%8F-quota}

https://docs.aws.amazon.com/general/latest/gr/healthomics-quotas.html

## 기타 링크 {#bkmrk-%EA%B8%B0%ED%83%80-%EB%A7%81%ED%81%AC}
...
- AWS genomics resources -- [Public Amazon ECR repositories[[![](data:image/svg+xml;base64,)]{.awsui_icon_h11ix_18tz4_189 .awsui_size-normal-mapped-height_h11ix_18tz4_248 .awsui_size-normal_h11ix_18tz4_244 .awsui_name-external_h11ix_18tz4_354 style="display: inline-block; position: relative; vertical-align: top; box-sizing: border-box; inline-size: var(--size-icon-normal-wflv4k, 16px); block-size: var(--line-height-body-m-2zx78l, 22px); padding-block: calc((var(--line-height-body-m-2zx78l, 22px) - var(--size-icon-normal-wflv4k, 16px)) / 2); padding-inline: 0px;"}]{style="transform: scale(0.85) translateY(2px);" aria-label="Opens in a new tab"}](https://gallery.ecr.aws/aws-genomics?page=1){style="background-color: transparent; color: var(--color-text-link-default-yuoe9q,#0073bb); text-decoration: none;" target="_blank" rel="noopener noreferrer"} related to genomics

- Python tutorials -- [Jupyter notebook tutorials[[![](data:image/svg+xml;base64,)]{.awsui_icon_h11ix_18tz4_189 .awsui_size-normal-mapped-height_h11ix_18tz4_248 .awsui_size-normal_h11ix_18tz4_244 .awsui_name-external_h11ix_18tz4_354 style="display: inline-block; position: relative; vertical-align: top; box-sizing: border-box; inline-size: var(--size-icon-normal-wflv4k, 16px); block-size: var(--line-height-body-m-2zx78l, 22px); padding-block: calc((var(--line-height-body-m-2zx78l, 22px) - var(--size-icon-normal-wflv4k, 16px)) / 2); padding-inline: 0px;"}]{style="transform: scale(0.85) translateY(2px);" aria-label="Opens in a new tab"}](https://github.com/aws-samples/amazon-omics-tutorials){style="background-color: transparent; color: var(--color-text-link-default-yuoe9q,#0073bb); text-decoration: none;" target="_blank" rel="noopener noreferrer"} on GitHub, covering HealthOmics storage, analytics, and workflows
:::

Become familiar with additional HealthOmics tools that AWS provides:

::: {#bkmrk-wdl-linter-%E2%80%93%C2%A0healtho .itemizedlist style="margin-bottom: 10px; color: rgb(15, 20, 26); font-family: 'Amazon Ember', Helvetica, Arial, sans-serif; font-size: 16px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;"}
- WDL linter -- [HealthOmics linter for WDL[[![](data:image/svg+xml;base64,)]{.awsui_icon_h11ix_18tz4_189 .awsui_size-normal-mapped-height_h11ix_18tz4_248 .awsui_size-normal_h11ix_18tz4_244 .awsui_name-external_h11ix_18tz4_354 style="display: inline-block; position: relative; vertical-align: top; box-sizing: border-box; inline-size: var(--size-icon-normal-wflv4k, 16px); block-size: var(--line-height-body-m-2zx78l, 22px); padding-block: calc((var(--line-height-body-m-2zx78l, 22px) - var(--size-icon-normal-wflv4k, 16px)) / 2); padding-inline: 0px;"}]{style="transform: scale(0.85) translateY(2px);" aria-label="Opens in a new tab"}](https://gallery.ecr.aws/aws-genomics/healthomics-linter){style="background-color: transparent; color: var(--color-text-link-default-yuoe9q,#0073bb); text-decoration: none;" target="_blank" rel="noopener noreferrer"}

- Nextflow linter -- [HealthOmics linter for Nextflow[[![](data:image/svg+xml;base64,)]{.awsui_icon_h11ix_18tz4_189 .awsui_size-normal-mapped-height_h11ix_18tz4_248 .awsui_size-normal_h11ix_18tz4_244 .awsui_name-external_h11ix_18tz4_354 style="display: inline-block; position: relative; vertical-align: top; box-sizing: border-box; inline-size: var(--size-icon-normal-wflv4k, 16px); block-size: var(--line-height-body-m-2zx78l, 22px); padding-block: calc((var(--line-height-body-m-2zx78l, 22px) - var(--size-icon-normal-wflv4k, 16px)) / 2); padding-inline: 0px;"}]{style="transform: scale(0.85) translateY(2px);" aria-label="Opens in a new tab"}](https://gallery.ecr.aws/aws-genomics/linter-rules-for-nextflow){style="background-color: transparent; color: var(--color-text-link-default-yuoe9q,#0073bb); text-decoration: none;" target="_blank" rel="noopener noreferrer"}

- HealthOmics Amazon ECR helper tool -- [Amazon ECR helper tool for HealthOmics[[![](data:image/svg+xml;base64,)]{.awsui_icon_h11ix_18tz4_189 .awsui_size-normal-mapped-height_h11ix_18tz4_248 .awsui_size-normal_h11ix_18tz4_244 .awsui_name-external_h11ix_18tz4_354 style="display: inline-block; position: relative; vertical-align: top; box-sizing: border-box; inline-size: var(--size-icon-normal-wflv4k, 16px); block-size: var(--line-height-body-m-2zx78l, 22px); padding-block: calc((var(--line-height-body-m-2zx78l, 22px) - var(--size-icon-normal-wflv4k, 16px)) / 2); padding-inline: 0px;"}]{style="transform: scale(0.85) translateY(2px);" aria-label="Opens in a new tab"}](https://github.com/aws-samples/amazon-ecr-helper-for-aws-healthomics){style="background-color: transparent; color: var(--color-text-link-default-yuoe9q,#0073bb); text-decoration: none;" target="_blank" rel="noopener noreferrer"}

- HealthOmics tools on GitHub -- [Tools for working with HealthOmics[[![](data:image/svg+xml;base64,)]{.awsui_icon_h11ix_18tz4_189 .awsui_size-normal-mapped-height_h11ix_18tz4_248 .awsui_size-normal_h11ix_18tz4_244 .awsui_name-external_h11ix_18tz4_354 style="display: inline-block; position: relative; vertical-align: top; box-sizing: border-box; inline-size: var(--size-icon-normal-wflv4k, 16px); block-size: var(--line-height-body-m-2zx78l, 22px); padding-block: calc((var(--line-height-body-m-2zx78l, 22px) - var(--size-icon-normal-wflv4k, 16px)) / 2); padding-inline: 0px;"}]{style="transform: scale(0.85) translateY(2px);" aria-label="Opens in a new tab"}](https://github.com/awslabs/amazon-omics-tools){style="background-color: transparent; color: var(--color-text-link-default-yuoe9q,#0073bb); text-decoration: none;" target="_blank" rel="noopener noreferrer"} (Transfer manager, URI parser, Omics rerun, Run analyzer).
:::

### 관련 블로그 {#bkmrk-%EA%B4%80%EB%A0%A8-%EB%B8%94%EB%A1%9C%EA%B7%B8}
