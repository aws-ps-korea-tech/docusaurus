...
[\![이미지](/img/omics-on-aws/screenshot-2024-04-18-at-11-32-14-pm.png)   ](/img/omics-on-aws/screenshot-2024-04-18-at-11-32-14-pm.png) ![이미지](/img/omics-on-aws/screenshot-2024-04-18-at-11-35-04-pm.png)

다른 모든 사항은 기본값으로 하여 Name만 지정해주었습니다.

![이미지](/img/omics-on-aws/screenshot-2024-04-18-at-11-36-34-pm.png)

### VPC 생성 확인 

만들어진 `hail-vpc` 이름의 VPC ID 를 확인합니다.

![이미지](/img/omics-on-aws/screenshot-2024-04-18-at-11-38-25-pm.png)

2\. 보안 그룹을 2개 생성합니다. 이때 앞에서 만든 VPC를 선택해야 합니다.

여기서는 `emr-primary-sg` 와 `emr-core-sg` 로 이름을 지정했습니다.

![이미지](/img/omics-on-aws/screenshot-2024-04-18-at-11-37-33-pm.png) [   ](/img/omics-on-aws/screenshot-2024-04-18-at-11-39-07-pm.png)![이미지](/img/omics-on-aws/screenshot-2024-04-18-at-11-40-01-pm.png)
...
![이미지](/img/omics-on-aws/screenshot-2024-04-18-at-11-40-57-pm.png)
...
![이미지](/img/omics-on-aws/screenshot-2024-04-18-at-11-42-51-pm.png)

#### Cluster configuration 

Cluster configuration 에서 Task  노드는 삭제합니다.

![이미지](/img/omics-on-aws/screenshot-2024-04-18-at-11-45-17-pm.png)
...
![이미지](/img/omics-on-aws/screenshot-2024-04-18-at-11-46-31-pm.png)
...
![이미지](/img/omics-on-aws/screenshot-2024-04-18-at-11-47-46-pm.png)

Subnet은 public 중에 선택합니다.

![이미지](/img/omics-on-aws/screenshot-2024-04-18-at-11-49-02-pm.png)

![이미지](/img/omics-on-aws/screenshot-2024-04-18-at-11-50-55-pm.png)

![이미지](/img/omics-on-aws/Nn0screenshot-2024-04-19-at-9-32-13-am.png)
...
![이미지](/img/omics-on-aws/screenshot-2024-04-18-at-11-51-22-pm.png)

#### Cluster logs 

클러스터 로그 설정에서 클러스터별 로그를 Amazon S3에 게시를 선택한 다음 S3 찾아보기를 클릭합니다. \"emr-dev-exp-xxxxx\"가 있는 버킷을 선택하고 /logs/ 접미사를 추가합니다.\

![이미지](/img/omics-on-aws/screenshot-2024-05-10-at-11-24-41-am.png)

#### [Security configuration and EC2 key pair] 

보안 구성 및 EC2 키 쌍에서 키 쌍을 만들고 ssh용 .pem 키 파일을 저장합니다.

![이미지](/img/omics-on-aws/screenshot-2024-04-18-at-11-52-53-pm.png)

![이미지](/img/omics-on-aws/screenshot-2024-04-18-at-11-53-19-pm.png)

#### [Identity and Access Management (IAM) roles] 

ID 및 액세스 관리 역할에서 서비스 역할 및 인스턴스 프로필 만들기를 선택할 수도 있습니다.

![이미지](/img/omics-on-aws/screenshot-2024-05-10-at-11-26-08-am.png)
...
![이미지](/img/omics-on-aws/screenshot-2024-05-10-at-11-25-22-am.png)

![이미지](/img/omics-on-aws/screenshot-2024-05-10-at-11-26-48-am.png)

### 클러스터 생성 확인  

다음과 같이 EMR 클러스터 생성을 확인합니다.

![이미지](/img/omics-on-aws/BhMscreenshot-2024-04-19-at-9-31-02-am.png)

EMR-master 에 대한 Security group 확인을 해봅니다. Edit inbound rules를 눌러 ssh 로 접속할 수 있도록 룰을 추가합니다.\

![이미지](/img/omics-on-aws/8c8screenshot-2024-04-19-at-9-47-48-am.png)

EMR-slave에 대한 Security group 확인 

![이미지](/img/omics-on-aws/dI2screenshot-2024-04-19-at-9-33-11-am.png)
...
``` 
aws emr ssh --cluster-id  --key-pair-file 
```
...
![이미지](/img/omics-on-aws/screenshot-2024-04-19-at-9-53-10-am.png)

Export PATH=\$PATH:/home/hadoop/.local/bin

![이미지](/img/omics-on-aws/screenshot-2024-04-19-at-10-36-37-am.png)
