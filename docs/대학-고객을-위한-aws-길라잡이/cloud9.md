...
[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2024-05-08-at-8-55-42-pm.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2024-05-08-at-8-55-42-pm.png){target="_blank" rel="noopener"}

Cloud9의 AWS 관리 콘솔 페이지는 다음과 같습니다.

[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2024-05-08-at-8-56-25-pm.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2024-05-08-at-8-56-25-pm.png){target="_blank" rel="noopener"}

## 1) Cloud9 환경 생성하기 {#bkmrk-1%29-cloud9-%ED%99%98%EA%B2%BD-%EC%83%9D%EC%84%B1%ED%95%98%EA%B8%B0}

환경 만들기 버튼을 선택합니다(환경 만들기 버튼이 보이지 않는 경우 아이콘을 선택하여 왼쪽 탐색 평면을 확장하고 환경을 선택한 다음 환경 만들기 버튼을 선택할 수 있습니다).

[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-10-18-at-11-19-38-am.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-10-18-at-11-19-38-am.png){target="_blank" rel="noopener"}

이제 Cloud9 환경을 생성할 수 있는 옵션이 표시됩니다:

[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-10-18-at-11-21-45-am.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-10-18-at-11-21-45-am.png){target="_blank" rel="noopener"}
...
페이지 오른쪽 하단에서 생성 버튼을 선택합니다.[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-10-18-at-11-22-01-am.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-10-18-at-11-22-01-am.png){target="_blank" rel="noopener"}

환경이 생성되면 Cloud9 환경 목록에 해당 환경이 표시됩니다:

[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-10-18-at-11-26-40-am.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-10-18-at-11-26-40-am.png){target="_blank" rel="noopener"}

이제 Cloud9 IDE 열에서 열기 링크를 선택합니다.Cloud9 로딩 페이지가 표시됩니다. Cloud9 IDE가 시작되는 데 몇 분 정도 걸릴 수 있습니다.

[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-10-18-at-11-52-24-am.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-10-18-at-11-52-24-am.png){target="_blank" rel="noopener"}

EC2에서 실행되는 Cloud9 환경에 오신 것을 환영합니다! 클라우드에 웹 인터페이스가 있는 가상 서버를 만들었습니다.

[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-10-18-at-11-27-52-am.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-10-18-at-11-27-52-am.png){target="_blank" rel="noopener"}

## 2) Bash 셸 사용해보기 {#bkmrk-2%29-bash-%EC%85%B8-%EC%82%AC%EC%9A%A9%ED%95%B4%EB%B3%B4%EA%B8%B0}
...
``` {#bkmrk-echo-%22hello-from-clo dir="ltr"}
echo "Hello from Cloud9"
```

Bash 셸 창의 결과는 다음과 같아야 합니다:

[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-10-18-at-11-28-41-am.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-10-18-at-11-28-41-am.png){target="_blank" rel="noopener"}
