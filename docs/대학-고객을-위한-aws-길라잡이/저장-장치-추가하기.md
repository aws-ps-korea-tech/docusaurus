...
## Amazon Elastic Block Store ([EBS](https://aws.amazon.com/ko/ebs/){target="_blank" rel="noopener"}) 볼륨 만들기 {#bkmrk-amazon-elastic-block .text_module_text__2cda07b4 .text_module_one__2cda07b4 .text_module_heading__2cda07b4 .text_module_block__2cda07b4}

1\. AWS 관리 콘솔 검색 창에 EC2를 입력하여 EC2 서비스로 이동합니다.

2\. 왼쪽 탐색 표시줄에서 **Elastic Block Store** 아래의 **Volumes**을 클릭합니다.

**[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-19-25-am.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-19-25-am.png){target="_blank" rel="noopener"}**
...
[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-21-34-am.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-21-34-am.png){target="_blank" rel="noopener"}

[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-22-23-am.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-22-23-am.png){target="_blank" rel="noopener"}

**5. Add Tag**를 클릭하여 리소스에 고유한 태그를 지정합니다. 키에 \'이름\'을 입력하고 값에 \'\[your initials\]-EBS\'를 입력합니다.

## 실행 중인 인스턴스에 EBS 볼륨 연결하기 {#bkmrk-attach-an-ebs-volume}

왼쪽 탐색 표시줄에서 Elastic Block Store 아래의 **Volumes**을 클릭하여 모든 볼륨을 확인합니다. 목록에서 이전 단계에서 제공된 고유 이름 태그를 검색하여 새로 생성한 볼륨을 선택할 수도 있습니다.

[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-24-55-am.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-24-55-am.png){target="_blank" rel="noopener"}
...
[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2024-05-09-at-9-49-28-am.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2024-05-09-at-9-49-28-am.png){target="_blank" rel="noopener"}성공적으로 연결된 경우 - 표시된 볼륨 목록에서 새 볼륨의 상태(상태 열 아래)가  **In Use**임을 나타내는 것을 볼 수 있습니다. 

[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-26-22-am.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-26-22-am.png){target="_blank" rel="noopener"}

3\. 왼쪽 탐색 창에서 항목 목록 맨 위에 있는 EC2 Dashboard 를 클릭하여 해당 인스턴스에 볼륨이 잘 연결되었는지 확인해볼 수 있습니다.

[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2024-05-09-at-9-50-18-am.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2024-05-09-at-9-50-18-am.png){target="_blank" rel="noopener"}
...
## 볼륨 마운트 {#bkmrk-mount-the-volume}

1\. EC2 인스턴스에 접속 및 로그인합니다. 앞에서 설명한 Cloud9 환경에서의 접속방법대로 해보세요. ([SSH 를 통한 EC2 인스턴스 접속](https://www.aws-ps-tech.kr/link/7#bkmrk-ssh-into-an-ec2-inst){target="_blank" rel="noopener"})
...
[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-30-52-am.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-30-52-am.png){target="_blank" rel="noopener"}
...
[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-30-43-am.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-30-43-am.png){target="_blank" rel="noopener"}

5\. 다음 명령을 사용하여 볼륨을 ext4 파일 시스템으로 포맷합니다. 실습이므로 새 장치입니다. 포멧이 되도 무방합니다. \

``` {#bkmrk-sudo-mkfs--t-ext4-%2Fd}
sudo mkfs -t ext4 /dev/nvme1n1
```

참고: 이 파일 시스템 포맷 단계는 [**새로 추가한 신규 볼륨 즉, 새로운 장 에만 해당**]{style="color: rgb(224, 62, 45);"}되며 그렇지 않을 경우는 기존 볼륨을 마운트하는 동안에는 장치의 모든 데이터가 지워지므로 **[이 단계를 실행하지 마세요]{style="color: rgb(224, 62, 45);"}**.

예)

[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-32-11-am.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-32-11-am.png){target="_blank" rel="noopener"}

6\. 새 ext4 볼륨을 마운트할 디렉터리를 원하는 대로 만듭니다. \"volume1\"이라는 이름을 사용하겠습니다.

``` {#bkmrk-sudo-mkdir-%2Fmnt%2Fvolu}
sudo mkdir /mnt/volume1
```

7\. 다음 명령을 사용하여 볼륨을 \"volume1\" 디렉터리에 마운트합니다.

``` {#bkmrk-sudo-mount-%2Fdev%2Fnvme}
sudo mount /dev/nvme1n1 /mnt/volume1
```

8\. 디렉터리로 이동하여 디스크 공간을 확인하여 볼륨 마운트를 확인합니다.

``` {#bkmrk-cd-%2Fmnt%2Fvolume1-df--}
cd /mnt/volume1
df -h .
```
...
``` {#bkmrk-sudo-chown--r-ubuntu}
sudo chown -R ubuntu /mnt/volume1
```

예)

[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-33-16-am.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-33-16-am.png){target="_blank" rel="noopener"}

[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-33-48-am.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-33-48-am.png){target="_blank" rel="noopener"}

10\. 참고로 나중에 이 장치를 제거할 수 있습니다. 마운트 해제 후 다시 마운트하는 연습을 해보세요. 볼륨을 마운트 해제하려면 다음 명령을 사용해야 합니다. 볼륨을 마운트 해제하려면 디렉터리 외부에 있어야 합니다.

``` {#bkmrk-sudo-umount-%2Fdev%2Fnvm}
...
``` {#bkmrk-sudo-mount-%2Fdev%2Fnvme-1}
sudo mount /dev/nvme1n1 /mnt/volume1
```
