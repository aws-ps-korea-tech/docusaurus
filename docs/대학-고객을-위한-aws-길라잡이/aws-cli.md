...
## AWS CLI 소개 {#bkmrk-%C2%A0}

[AWS CLI](https://aws.amazon.com/cli/){.highlight}를 사용하면 명령줄을 사용하여 서비스를 관리하고 스크립트를 통해 서비스를 제어할 수 있습니다. 많은 사용자가 AWS CLI를 사용하여 일정 수준의 자동화를 수행합니다.

최신 버전의 AWS CLI 설치 또는 업데이트는 [다음](https://docs.aws.amazon.com/ko_kr/cli/latest/userguide/getting-started-install.html)을 참고해주세요. 

### AWS CLI 사용 {#bkmrk-check-existing-amazo}
...
[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-10-18-at-12-05-36-pm.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-10-18-at-12-05-36-pm.png){target="_blank" rel="noopener"}
...
``` {#bkmrk-aws-ec2-describe-ins}
aws ec2 describe-instances
```

``` {#bkmrk-aws-ec2-describe-key}
...
### 계정 설정 (워크샵 스튜디오 사용자) {#bkmrk-%EA%B3%84%EC%A0%95-%EC%84%A4%EC%A0%95-%28%EC%9B%8C%ED%81%AC%EC%83%B5-%EC%8A%A4%ED%8A%9C%EB%94%94%EC%98%A4-%EC%82%AC%EC%9A%A9%EC%9E%90%29}
...
[\![\](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-52-34-am.png)](/img/대학-고객을-위한-aws-길라잡이/screenshot-2023-09-27-at-10-52-34-am.png){target="_blank" rel="noopener"}

[\![\](/img/대학-고객을-위한-aws-길라잡이/LPAscreenshot-2023-09-27-at-10-52-25-am-copy.png)](/img/대학-고객을-위한-aws-길라잡이/LPAscreenshot-2023-09-27-at-10-52-25-am-copy.png){target="_blank" rel="noopener"}

터미널 창에 바로 Copy & Paste 할 수 있습니다.

이제 다시 한번 `aws ec2 describe-key-pairs` 명령어를 입력해보세요.

[\![\](/img/대학-고객을-위한-aws-길라잡이/untitled.png)](/img/대학-고객을-위한-aws-길라잡이/untitled.png){target="_blank" rel="noopener"}

###  {#bkmrk-%C2%A0-3}

### 계정 설정 (개인 AWS 계정) {#bkmrk-%EA%B3%84%EC%A0%95-%EC%84%A4%EC%A0%95-%28%EC%9D%BC%EB%B0%98-aws-%EA%B3%84%EC%A0%95-%EC%82%AC%EC%9A%A9%EC%9E%90}

[워크샵 스튜디오 환경에서 진행할 경우 아래 내용을 따라갈 필요는 없습니다!]{lang="KO"}

계정 설정 (일반 AWS 계정 사용자)

#### Configuration {#bkmrk-%EC%B0%B8%EA%B3%A0%3A-%EC%9C%84%EC%97%90%EC%84%9C-%EC%B2%98%EB%9F%BC%C2%A0}
...
``` {#bkmrk-cat-%7E%2F.aws%2Fcredentia}
cat ~/.aws/credentials
```

``` {#bkmrk-cat-%7E%2F.aws%2Fconfig}
cat ~/.aws/config
```

이제 사용자 신원을 성공적으로 구성했습니다. 

### 참고자료 {#bkmrk-%EC%B0%B8%EA%B3%A0%EC%9E%90%EB%A3%8C}
